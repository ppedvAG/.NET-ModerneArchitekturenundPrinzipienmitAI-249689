using LabCleanArchitecture.Application.Common.Models;
using LabCleanArchitecture.Application.TodoItems.Commands.CreateTodoItem;
using LabCleanArchitecture.Application.TodoItems.Commands.DeleteTodoItem;
using LabCleanArchitecture.Application.TodoItems.Commands.UpdateTodoItem;
using LabCleanArchitecture.Application.TodoItems.Commands.UpdateTodoItemDetail;
using LabCleanArchitecture.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace LabCleanArchitecture.Web.Endpoints;
